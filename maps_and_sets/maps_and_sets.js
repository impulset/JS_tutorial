...
firstMap.set(1, 'Ash').set(2, 'Element');
...
//Reverse Map to Array
const newArr = [...bandMap]

//Check if Map contains something using has()
bandMap.has(3) //true
...
//Get keys / values
bandMap.keys()
const arrayOfKeys = [...bandMap.keys()]

bandMap.values()
const arrayOfValues = [...bandMap.values()]
...
firstMap.forEach((v, k) => console.log(v, k)); //first is value, second is key
...
annoyingHashTags.add("#Blessed").add("Bestlife")
